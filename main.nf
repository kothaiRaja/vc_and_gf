...
process TRIM_READS {
    ...
    tuple val(sample_id), path("${sample_id}_fastp.html"), path("${sample_id}_fastp.json"), val(strandedness), emit: fastp_reports
...
process STAR_ALIGNMENT {
    ...
    output:
    tuple val(sample_id), path("${sample_id}_Aligned.sortedByCoord.out.bam"), val(strandedness)
